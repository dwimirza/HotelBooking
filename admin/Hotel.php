...
<body>
  ...
  fetch('includes/managehotel.php?action=getHotelData&id=' + hotelId)
    ...
    .then(data => {
      ...
      document.getElementById('hotelRating').value  = data[0].rating  || '';
    })
                    ...
                    <table id="basic-datatables" class="display table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a onclick="openModal(<?php echo $hotel['hotel_id']?>)" class="btn btn-primary me-2">Edit</a><a
                              href="./includes/delete.php?type=hotel&id=<?php echo $hotel['hotel_id']?>"
